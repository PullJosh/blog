...
import logo from "../images/josh-pullen-logo.webp";
  ...
  return (
    <div className="flex flex-col items-stretch min-h-screen">
      ...
      <div className="mt-16 mb-24">
        <main className="max-w-2xl px-8 mx-auto">{children}</main>
      </div>
      <footer className="py-8 mt-auto bg-gray-200 select-none">
        <div className="max-w-2xl px-8 mx-auto">
          <section className="grid p-8 mb-8 -mt-16 text-white bg-gray-800 rounded-lg shadow-lg">
            <h3 className="inline mb-1 text-xl font-semibold text-white md:text-2xl">
              Don't miss out on{" "}
            ...
            <p className="mb-8 mr-8 text-lg text-gray-400">
              Education and technology updates sent to your inbox. Unsubscribe
              any time.
            </p>
            <form
            ...
            >
              ...
              <input
                type="submit"
                value="Subscribe"
                className="px-4 py-2 m-1 text-lg bg-indigo-600 rounded shadow cursor-pointer"
              />
            </form>
          </section>
          <div className="flex">
